...
- A machine with no Zeroconf provider installed logs a single message instead of an error, and OSC input is unaffected.
...
- **Breaking:** `Controllable.hasPresets` is removed.
